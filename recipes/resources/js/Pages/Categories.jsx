        ...
        <>
            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div className="flex justify-center" >
                       <h1 className="relative text-center right text-4xl font-extrabold text-gray-900">Categories</h1>
                    </div>
                    ...
                    <div className="mt-16" >
                        ...
                        {props.categories && props.categories.map(category =>
                            <a
                                href={'Recipes/by_category/' + category.name}
                            ...
                            <div>
                                <h2 className="mt-6 text-xl font-semibold text-gray-900 dark:text-white justify-center">
                                    ...
                                    <img style={{width:"90%", height:"60%", padding:"3%", justify:"center"}} src={category.image}>
                                    </img>
                            </div>
                            </a>
                        )}
