        ...
        <>
            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div className="flex justify-center" >
                       <h1 className="relative text-center right text-4xl font-extrabold text-gray-900"> Quick and easy recipes</h1>
                    </div>
                        ...
                        <div className= "grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                                   ...
                                   <p className="mt-4 text-xl text-white-500 text-bold dark:text-gray-900 leading-relaxed">
                                        Breakfast Recipies
                                            ...
                                            <ul>Salsa Verde Baked Eggs</ul>
                                            <ul>Sour Cream Coffee Cake</ul>
                                            <ul>Gingerbread loaf</ul>
